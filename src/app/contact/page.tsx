              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:mittibloom8@gmail.com" className="text-olive-600 hover:underline">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+918851491544" className="text-olive-600 hover:underline">
                      +91 88514 91544
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-olive-600 text-white py-3 px-6 rounded-lg font-medium hover:bg-olive-700 transition-colors"
                  >
                    Send Message
                  </button>
                </form>
            ...
            {[
              {
                ...
                a: "We typically ship within 1-2 business days. Delivery takes 3-5 days within India.",
              },
              {
              ...
              },
              {
                ...
                a: "Most of our products are vegan. Products containing honey or goat milk are clearly labeled.",
              },
              {
